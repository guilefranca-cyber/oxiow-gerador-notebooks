...
LINHAS = [
    ...
    '',
    '# PATCH 1: o repo importa de modeling_utils, mas desde o 0.33 a funcao mora',
    '# em model_loading_utils. Sem isso o modo economico de memoria desliga -> OOM.',
    '_f = None',
    'try:',
    ...
    '    print("[patch1] VERIFICADO: o import do repo agora funciona", flush=True)',
    'except Exception as e:',
    '    print("[patch1] AINDA FALHA:", repr(e), flush=True)',
    '',
    ...
    '',
    '# PATCH 4 (O DECISIVO): DESLIGAR o low_cpu_mem_usage.',
    '# Ele cria o modelo num "meta device" (rascunho vazio) e o diffusers >= 0.37',
    '# preenche com copy_(), que NAO funciona em tensor meta. Resultado medido:',
    '#   NotImplementedError: Cannot copy out of meta tensor; no data!',
    '#   (no pipeline.to(device), depois de carregar tudo)',
    '# Sem ele o modelo materializa de verdade. O mmap (patch 2) ja resolve a RAM:',
    '# medimos pico de 23,0 GB em 32,9 GB — cabe.',
    'sys.path.insert(0, ".")',
    'try:',
    ...
    '                print("[patch4] forcando low_cpu_mem_usage=False", flush=True)',
    '                return o(*a, **kw)',
    '            return _p',
    '        _cls.from_pretrained = _fabrica(_orig)',
    '    print("[patch4] OK — o modelo agora materializa de verdade", flush=True)',
