...
LINHAS = [
    ...
    '',
    '# PATCH 6: A T4 tem 14,56 GB e "pipeline.to(device)" tenta empurrar TUDO de uma',
    '# vez (T5 11,36 GB + CLIP 4,77 GB + 2 transformers + VAE) -> CUDA out of memory.',
    '# O traceback aponta diffusers/pipelines/pipeline_utils.py:565, in to — entao',
    '# interceptar DiffusionPipeline.to resolve sem editar o repo.',
    '# Com offload, cada modulo sobe para a placa so na hora de usar.',
    'try:',
    ...
    '            print("[patch6] offload por modulo LIGADO (no lugar do to)", flush=True)',
    '            return self',
    '        except Exception as _e6:',
    '            print("[patch6] offload falhou:", repr(_e6)[:150], flush=True)',
    '            try:',
    '                self.enable_sequential_cpu_offload()',
    '                print("[patch6] offload sequencial LIGADO", flush=True)',
    '                return self',
    '            except Exception as _e7:',
    '                print("[patch6] sequencial falhou:", repr(_e7)[:150], flush=True)',
    '                return _to_orig(self, *a, **kw)',
    '    _DP.to = _to_inteligente',
    '    print("[patch6] DiffusionPipeline.to interceptado", flush=True)',
    'except Exception as _e:',
